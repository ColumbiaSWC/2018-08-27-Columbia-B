...
venue: "Columbia University, Programming in Python 2"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Butler Library 208B, 535 West 114th Street, New York, NY"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/ISO_639-1)
latlng: "40.806444, -73.963194"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "August 27-28, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2018-08-29        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Marii Nyröp", "Cesar Arias"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jochen Weber", "Yanchen Liu", "Parixit Davé"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p id="where">
  ...
  {{page.address}}.
  Get directions with
{% comment %}  <a href="//www.openstreetmap.org/?mlat={{page.latlng | replace:',','&mlon='}}&zoom=16">OpenStreetMap</a>
  or
{% endcomment %}
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <p>
        ...
        It will be pre-installed after Git for Windows has been installed.
      </p>
      <p>
